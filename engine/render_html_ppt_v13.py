...
def render_file(input_path: Path, output_path: Path, theme: str = "editorial", showoff: bool = False) -> int:
    ...
    result = validate_reading_html(html, showoff=showoff)
    if not result.ok:
...
def main() -> int:
    ...
    return render_file(input_path, output_path, theme=args.theme, showoff=args.showoff)
